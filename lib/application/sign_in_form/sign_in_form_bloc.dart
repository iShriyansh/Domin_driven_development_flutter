...
import 'package:domin_driven_development_firebase/domain/auth/i_auth_facade.dart';
...
class SignInFormBloc extends Bloc<SignInFormEvent, SignInFormState> {
  ...
  SignInFormBloc(this._authFacade) : super(_Initial());

  @override
  Stream<SignInFormState> mapEventToState(
    SignInFormEvent event,
  ) async* {
    yield* event.map(emailChnaged: (e) async* {
...
SignInFormState _Initial() => SignInFormState.initial();
